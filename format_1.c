...
int to_char(va_list conv, __attribute__ ((unused)) char f, int w)
{
...
int to_string(va_list conv, __attribute__ ((unused)) char f, int w)
{
...
int to_b(va_list conv, __attribute__ ((unused)) char f,
