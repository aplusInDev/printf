...
int to_o(va_list conv, __attribute__ ((unused)) char f, int w)
{
...
int to_S(va_list conv, __attribute__ ((unused)) char f,
...
int to_p(va_list conv, __attribute__ ((unused)) char f, int w)
{
